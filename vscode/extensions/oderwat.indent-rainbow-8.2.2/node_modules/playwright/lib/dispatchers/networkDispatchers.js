...
class FetchRequestDispatcher extends _dispatcher.Dispatcher {
  ...
  async fetch(params, metadata) {
    const {
      fetchResponse,
      error
    } = await this._object.fetch({
      url: params.url,
      params: (0, _utils.arrayToObject)(params.params),
      method: params.method,
      headers: params.headers ? (0, _utils.headersArrayToObject)(params.headers, false) : undefined,
      postData: params.postData ? Buffer.from(params.postData, 'base64') : undefined,
