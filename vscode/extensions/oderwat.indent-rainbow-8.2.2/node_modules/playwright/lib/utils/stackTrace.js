...
const CLIENT_LIB = _path.default.join(ROOT_DIR, 'lib', 'client');

const CLIENT_SRC = _path.default.join(ROOT_DIR, 'src', 'client');
...
function captureStackTrace() {
  ...
  let apiName = ''; // Deepest transition between non-client code calling into client code
  // is the api entry.
