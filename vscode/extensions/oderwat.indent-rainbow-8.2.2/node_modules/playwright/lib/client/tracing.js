...
class Tracing {
  ...
  async _doStopChunk(channel, path) {
    ...
    if ((_this$_context$_brows = this._context._browser) !== null && _this$_context$_brows !== void 0 && _this$_context$_brows._remoteType) artifact._isRemote = true;
